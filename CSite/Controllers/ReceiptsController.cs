...
namespace CSite.Controllers
{
    ...
    [ApiController]
    public class ReceiptsController : SupplierControllerGeneric<Receipts, ReceiptsDTO>
    {
        public ReceiptsController(ControllerHelper _controllerHelper) : base(_controllerHelper) { }
    }

    [Authorize]
    public class SupplierControllerGeneric<TEntity, TEntityDTO> : ControllerBase
        where TEntity : Receipts
        where TEntityDTO : ReceiptsDTO
    {
