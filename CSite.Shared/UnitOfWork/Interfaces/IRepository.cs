...
namespace CSite.Shared.Interfaces
{
    ...
    public interface IRepository<TEntity> : IDisposable where TEntity : class
    {
        ...
        /// <summary>
        /// Any based on a predicate.
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns></returns>
        Task<bool> AnyAsync(Expression<Func<TEntity, bool>> predicate = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the count based on a predicate.
        /// </summary>
        /// <param name="predicate"></param>
        ...
        /// <summary>
        /// Deletes the specified entity by Id asynchronously.
        /// </summary>
